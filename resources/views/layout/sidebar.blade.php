    ...
    <div>
      ...
      <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
        <ul id="sidebarnav">
          ...
          <li class="sidebar-item">
            <a class="sidebar-link" href="{{route('tipoOrganizacion')}}" aria-expanded="false">
              <span>
                <i class="ti ti-article"></i>
              </span>
              <span class="hide-menu">Tipo de Organizacion</span>
            </a>
          </li>
          <li class="sidebar-item">
            <a class="sidebar-link" href="{{route('directivo')}}" aria-expanded="false">
              ...
              <span class="hide-menu">Directivos</span>
            </a>
          </li>
          <li class="sidebar-item">
